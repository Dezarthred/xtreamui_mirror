...
rDownloadURL = "https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/sub_xtreamcodes_reborn.tar.gz"
...
def configure():
    ...
    os.system("wget --user-agent=\"Mozilla/5.0\" -q https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/nginx_rtmp -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx_rtmp")
