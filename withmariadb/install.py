...
rDownloadURL = {"main": "https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/main_xtreamcodes_reborn.tar.gz", "sub": "https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/sub_xtreamcodes_reborn.tar.gz"}
...
def installadminpanel():
    rURL = "https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/release_22f.zip"
    ...
    rURL2 = "https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/newstuff.zip"
...
def configure():
    ...
    if rType == "MAIN": 
        ...
        os.system("sed -i 's|https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/balancer.py|https://github.com/Dezarthred/xtreamui_mirror/raw/master/withmariadb/balancer.py|g'  /home/xtreamcodes/iptv_xtream_codes/pytools/balancer.py")
    ...
    os.system("wget --user-agent=\"Mozilla/5.0\"  -q https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/nginx -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx")
    os.system("wget --user-agent=\"Mozilla/5.0\" -q https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/nginx_rtmp -O /home/xtreamcodes/iptv_xtream_codes/nginx_rtmp/sbin/nginx_rtmp")
    os.system("wget --user-agent=\"Mozilla/5.0\" -q https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
    ...
    os.system("wget --user-agent=\"Mozilla/5.0\" -q https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
...
if __name__ == "__main__":
    ...
    print "%s │ Check out the mirror repo: https://github.com/Dezarthred/xtreamui_mirror/withmariadb %s" % (col.OKGREEN, col.ENDC)
    print " "
