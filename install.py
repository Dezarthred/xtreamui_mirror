...
def configure():
    ...
    os.system("wget -q https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/nginx -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx")
    os.system("wget -q https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/nginx_rtmp -O /home/xtreamcodes/iptv_xtream_codes/nginx_rtmp/sbin/nginx_rtmp")
    os.system("wget -q https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
    ...
    os.system("wget -q https://bitbucket.org/IgorTristante/xtream_mirrors/downloads/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    os.system('chattr -f +i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb > /dev/null')
...
if __name__ == "__main__":
    ...
    print "%s │ Check out the mirror repo: https://bitbucket.org/IgorTristante/xtream_mirrors %s" % (col.OKGREEN, col.ENDC)
    print " "
